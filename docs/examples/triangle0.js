...
var vertShader_30091 = /**/[gl_30002[0].createShader(35633)];
gl_30002[0].shaderSource(vertShader_30091[0], toJSStr(vertCode_30082[0]));
gl_30002[0].compileShader(vertShader_30091[0]);
...
if (!(getStatus_29029(gl_30002[0], vertShader_30091[0]))) {
console.log("error vs");
}

var fragCode_30095 = /**/[makeNimstrLit("void main(void){gl_FragColor = vec4(0.0, 0.0, 0.0, 0.1);}")];
var fragShader_30104 = /**/[gl_30002[0].createShader(35632)];
gl_30002[0].shaderSource(fragShader_30104[0], toJSStr(fragCode_30095[0]));
gl_30002[0].compileShader(fragShader_30104[0]);
if (!(getStatus_29029(gl_30002[0], fragShader_30104[0]))) {
console.log("error fg");
}

var shaderProgram_30108 = /**/[gl_30002[0].createProgram()];
gl_30002[0].attachShader(shaderProgram_30108[0], vertShader_30091[0]);
gl_30002[0].attachShader(shaderProgram_30108[0], fragShader_30104[0]);
gl_30002[0].linkProgram(shaderProgram_30108[0]);
...
if (!(getStatus_29034(gl_30002[0], shaderProgram_30108[0]))) {
console.log("error p");
}

gl_30002[0].useProgram(shaderProgram_30108[0]);
gl_30002[0].bindBuffer(34962, vertex_buffer_30012[0]);
gl_30002[0].bindBuffer(34963, Index_Buffer_30047[0]);
var coord_30132 = /**/[gl_30002[0].getAttribLocation(shaderProgram_30108[0], "coordinates")];
gl_30002[0].vertexAttribPointer(coord_30132[0], 3, 5126, false, 0, 0);
gl_30002[0].enableVertexAttribArray(coord_30132[0]);
