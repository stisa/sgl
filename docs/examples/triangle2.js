...
resizeToDisplaySize_54309(canvas_59001[0], 1.0000000000000000e+000);
...
var vertCode_59013 = /**/[makeNimstrLit("attribute vec3 coordinates;\x0Avoid main(void) {\x0A gl_Position = vec4(coordinates, 1.0);\x0A}")];
var fragCode_59014 = /**/[makeNimstrLit("void main(void){\x0A  gl_FragColor = vec4(0.0, 0.0, 0.0, 0.1);\x0A}")];
...
var stt_59015 = /**/[state_58011(gl_59002[0], vertCode_59013[0], fragCode_59014[0])];
function upload_59035(b_59039, data_59042) {

var F={procname:"upload.upload",prev:framePtr,filename:"C:\\Users\\stisa\\OneDrive\\Progetti\\sgl\\src\\sgl\\buffer.nim",line:0};
framePtr = F;
b_59039.gl.bindBuffer(b_59039.kind, b_59039.glbuffer);
b_59039.gl.bufferData(b_59039.kind, new Float32Array(data_59042), b_59039.drawmode);
framePtr = F.prev;
}
function upload_59071(b_59075, data_59078) {

var F={procname:"upload.upload",prev:framePtr,filename:"C:\\Users\\stisa\\OneDrive\\Progetti\\sgl\\src\\sgl\\buffer.nim",line:0};
framePtr = F;
b_59075.gl.bindBuffer(b_59075.kind, b_59075.glbuffer);
b_59075.gl.bufferData(b_59075.kind, new Uint16Array(data_59078), b_59075.drawmode);
framePtr = F.prev;
}
function upload_59022(s_59027, vertices_59030, indices_59033) {

var F={procname:"upload.upload",prev:framePtr,filename:"C:\\Users\\stisa\\OneDrive\\Progetti\\sgl\\src\\sgl\\state.nim",line:0};
framePtr = F;
upload_59035(s_59027.vb, vertices_59030);
upload_59071(s_59027.ib, indices_59033);
bindBuffers_57050([s_59027.vb, s_59027.ib]);
F.line = 47;
s_59027.il = chckRange((indices_59033 != null ? indices_59033.length : 0), 0, 2147483647);
F.line = 48;
s_59027.vl = chckRange((vertices_59030 != null ? vertices_59030.length : 0), 0, 2147483647);
framePtr = F.prev;
}
upload_59022(stt_59015[0], vertices_59009[0], indices_59012[0]);
...
point_58112(stt_59015[0], makeNimstrLit("coordinates"));
...
drawAsTriangle_58127(stt_59015[0]);
